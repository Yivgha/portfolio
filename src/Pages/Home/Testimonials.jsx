        ...
        <section id="testimonials" className="testimonialsSection">
            <div className="portfolioContainerBox">
                <div className="portfolioContainer">
                    <p className="subTitle">Clients Feedback</p>
                    <h2 className="sectionsHeading">Customers Feedback</h2>
                </div>
            </div>
            <div className="portfolioSectionContainer">
                {data?.testimonial?.map((item, index) => (
                    <div key={index} className="testimonialsSectionCard">
                        <div className="testimonialsSectionCardReview">
                ...
                >
                  ...
                  />
                        ...
                        <div className="testimonialsSectionCardAuthorDetail">
                            <img src={item.src} alt={item.author_name} />
                            <div>
                                <p className="textMD testimonialsAuthorName">{item.author_name}</p>
                                <p className="textMD testimonialsAuthorDesignation">{item.author_designation}</p>
                            </div>
                        </div>
                    </div>
                ))}
