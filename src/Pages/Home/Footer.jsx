      ...
      <div className="footerLinkContainer">
       <Link to="heroSection"
        ...
        duration={500}
         ...
         onClick={()=>navigate("/")}>
          <img src="./portfolio.png" alt="logo" className="footerLogo" />
        </Link>
            ...
            <li>
              ...
              >
                 <svg
                  ...
                  fill="none"
                >
<path d="M24.325 3h4.411l-9.636 11.013 11.336 14.987h-8.876l-6.952-9.089-7.955 9.089h-4.413l10.307-11.78-10.875-14.22h9.101l6.284 8.308zM22.777 26.36h2.444l-15.776-20.859h-2.623z" fill="currentColor"></path>
</svg>
              </a>
            </li>
            <li>
              <a
                href="https://www.linkedin.com/in/yevheniia-plaskon/"
                className="navbarContent"
                target="_blank"
                rel="noreferrer noopener"
              >
      ...
      <div className="footerContentContainer">
        <p className="footerContent">(c) 2023 Made with <span className="pulse"><span className="heart">💖</span></span> by Yivgha</p>
        <div className="footerSocialIcon">
          <ul>
            <li className="footerPrivacyLi">
